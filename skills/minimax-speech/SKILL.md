...
| 任务 | 命令/函数 | 说明 |
|------|-----------|------|
| 命令行合成 | `python scripts/text_to_speech.py "文本" -o output.mp3` | 快速生成音频 |
| Python 完整流程 | `text_to_speech(text, voice_id, model, output_file)` | 一站式生成音频 |
...
```bash
# 基础用法
python scripts/text_to_speech.py "你好，欢迎使用 MiniMax 语音合成"

# 指定输出文件
python scripts/text_to_speech.py "你好世界" -o hello.mp3

# 指定音色
python scripts/text_to_speech.py "欢迎使用" -v female-yujie

# 指定模型
python scripts/text_to_speech.py "测试文本" -m speech-02-turbo
```
